...
public class BaseUidTest {
  ...
  @Test
  public void testHasLetterIn2023() {
    String base2023 = BaseUid.from(Instant.ofEpochSecond(1672531200L));
    assertTrue(base2023.startsWith("Aak"));
  }

  @Test
  public void testHasLetterIn2024() {
    String base2024 = BaseUid.from(Instant.ofEpochSecond(1704067200L));
    assertTrue(base2024.startsWith("Aok"));
  }

  @Test
  public void testHasLetterIn2038() {
    String base2038 = BaseUid.from(Instant.ofEpochSecond(2145916800L));
    assertTrue(base2038.startsWith("Dsy"));
  }

  @Test
  public void testRange48() {
  ...
  @Test
  public void testRange48_withNanos() {
